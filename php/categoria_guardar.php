<?php
    ...
    # Verificando nombre de categoría
    ...
    if($check_nombre->rowCount()>0){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrió un error inesperado!</strong><br>
                El NOMBRE de la categoría ingresada ya se encuentra registrado, por favor elija otro
            </div>
        ';
        exit();
    }
    ...
    if($guardar_categoria->rowCount()==1){
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrió un error inesperado!</strong><br>
                No se pudo registrar la categoría, por favor intenta nuevamente
            </div>
        ';
    }
