<?php
    ...
    if (in_array($modulo_buscador, $modulos)) {
        $_SESSION['busqueda_'.$modulo_buscador]=limpiar_cadena($_POST['txt_buscador']);
        ...
        header("Location: index.php?vista=".$modulo_url);
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrió un error inesperado!</strong><br>
                No se pudo procesar la busqueda, por favor intente nuevamente.
            </div>
        ';
    }
